    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 10, 56, 4, 80757))),
                ('f_updatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 10, 56, 4, 80767))),
