    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdate', models.DateTimeField(blank=True, verbose_name=datetime.datetime(2022, 5, 23, 10, 21, 46, 681775))),
                ('updatedate', models.DateTimeField(blank=True, verbose_name=datetime.datetime(2022, 5, 23, 10, 21, 46, 681793))),
