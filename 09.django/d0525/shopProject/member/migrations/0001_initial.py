    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdate', models.DateTimeField(blank=True, verbose_name=datetime.datetime(2022, 5, 25, 10, 13, 31, 764477))),
                ('updatedate', models.DateTimeField(blank=True, verbose_name=datetime.datetime(2022, 5, 25, 10, 13, 31, 764496))),
            ],
        ),
    ]
