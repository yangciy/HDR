...
path=os.listdir('/Users/uk/Desktop/하체라벨링')
...
for folder in path:
    files=os.listdir(f'/Users/uk/Desktop/하체라벨링/{folder}')
    ...
    for load in files_2d:
        print(folder)
        print(load)
        with open(f'/Users/uk/Desktop/하체라벨링/{folder}/{load}', "r", encoding="utf8") as f:
