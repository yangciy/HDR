...
for folder in path:
    files=os.listdir(f'/Users/uk/Desktop/[라벨]맨몸운동_Labeling/{folder}')
    ...
    for load in files_2d:
        print(folder)
        print(load)
        with open(f'/Users/uk/Desktop/[라벨]맨몸운동_Labeling/{folder}/{load}', "r", encoding="utf8") as f:
